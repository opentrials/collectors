...
def upgrade():
    op.create_table('euctr',
        ...
        sa.Column('subject_women_of_childbearing_potential_not_using_contraception', sa.Boolean),
        sa.Column('subject_women_of_childbearing_potential_using_contraception', sa.Boolean),
